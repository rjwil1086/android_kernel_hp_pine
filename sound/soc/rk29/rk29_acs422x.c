/*
 * rk29_acs422x.c  --  SoC audio for Rockchip
 *
	...
	struct snd_pcm_hw_params *params)
{
	...
	ret = snd_soc_dai_set_sysclk(codec_dai, ACS422_MCLK, pll_out, SND_SOC_CLOCK_IN);
	if (ret < 0) {
		dev_err(codec_dai->dev, "failed to set sysclk\n"); 
	}
#endif
#if defined (CONFIG_SND_RK29_CODEC_SOC_MASTER)
	ret = snd_soc_dai_set_sysclk(codec_dai, ACS422_MCLK, pll_out, SND_SOC_CLOCK_IN);
...
static struct snd_soc_dai_link rk29_dai = {
	.name = "ACS422",
	.stream_name = "ACS422 PCM",
	.codec_name = "ACS422.0-0069",
