...
#define AIC_PDET_PIN RK30_PIN4_PC4
#define AIC_PDET_MUX_NAME GPIO4C4_SMCDATA4_TRACEDATA4_NAME
#define AIC_PDET_MUX_GPIO GPIO4C_GPIO4C4
#define AIC_PDET_IN GPIO_HIGH

#define AIC_SPK_PIN RK30_PIN4_PD1
#define AIC_SPK_MUX_NAME GPIO4D1_SMCDATA9_TRACEDATA9_NAME
#define AIC_SPK_MUX_GPIO GPIO4D_GPIO4D1
#define AIC_SPK_PWDN GPIO_LOW
