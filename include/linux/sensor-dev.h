...
struct sensor_operate {
	...
	int (*auto_calibration)(struct i2c_client *client,struct calibrate_offset *offset);
	int (*set_calibration)(struct i2c_client *client,struct calibrate_offset *offset);
...
#define GSENSOR_IOCTL_CALIBRATE                    0xA105 
#define GSENSOR_IOCTL_SET_CALIBRATE_OFFSET                 0xA106
