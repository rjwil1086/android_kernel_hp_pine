...
//
    ...
    #define BT_HOST_WAKE RK30_PIN6_PA7
    //power
    #define RK30SDK_WIFI_GPIO_POWER_N               RK30_PIN1_PA6                 
    ...
    #define RK30SDK_WIFI_GPIO_POWER_IOMUX_FGPIO     GPIO1A_GPIO1A6
    //power down
    #define RK30SDK_WIFI_GPIO_POWER_DOWN_N               RK30_PIN3_PD1                 
    #define RK30SDK_WIFI_GPIO_POWER_DOWN_ENABLE_VALUE    GPIO_LOW                   
    #define RK30SDK_WIFI_GPIO_POWER_DOWN_PIN_NAME        GPIO3D1_SDMMC1BACKENDPWR_NAME
    #define RK30SDK_WIFI_GPIO_POWER_DOWN_IOMUX_FGPIO     GPIO3D_GPIO3D1
    //reset
    #define RK30SDK_WIFI_GPIO_RESET_N               RK30_PIN3_PD0
    #define RK30SDK_WIFI_GPIO_RESET_ENABLE_VALUE    GPIO_LOW
    #define RK30SDK_WIFI_GPIO_RESET_PIN_NAME        GPIO3D0_SDMMC1PWREN_NAME
    #define RK30SDK_WIFI_GPIO_RESET_IOMUX_FGPIO     GPIO3D_GPIO3D0
    //power VD
    #define RK30SDK_WIFI_GPIO_POWER_VD_N              RK30_PIN0_PD0
    #define RK30SDK_WIFI_GPIO_POWER_VD_ENABLE_VALUE    GPIO_LOW
    #define RK30SDK_WIFI_GPIO_POWER_VD_PIN_NAME        GPIO0D0_I2S22CHCLK_SMCCSN0_NAME
    #define RK30SDK_WIFI_GPIO_POWER_VD_IOMUX_FGPIO     GPIO0D_GPIO0D0
    //power VD
    #define RK30SDK_WIFI_GPIO_POWER_1V8_N              RK30_PIN0_PD1
    #define RK30SDK_WIFI_GPIO_POWER_1V8_ENABLE_VALUE    GPIO_LOW
    #define RK30SDK_WIFI_GPIO_POWER_1V8_PIN_NAME        GPIO0D1_I2S22CHSCLK_SMCWEN_NAME
    #define RK30SDK_WIFI_GPIO_POWER_1V8_IOMUX_FGPIO     GPIO0D_GPIO0D1
    ...
    switch(device_id)
    {
        case 0://mmc0
        {
            ...
            if(on)
            {
                ...
                gpio_direction_output(rksdmmc0_gpio_init.clk_gpio.io,GPIO_HIGH);//set mmc0-clk to low.
                ...
                gpio_direction_output(rksdmmc0_gpio_init.cmd_gpio.io,GPIO_HIGH);//set mmc0-cmd to low.
                //gpio_pull_updown(rksdmmc0_gpio_init.cmd_gpio.io,GPIOPullUp);
                ...
                gpio_direction_output(rksdmmc0_gpio_init.data0_gpio.io,GPIO_HIGH);//set mmc0-data0 to low.
                //gpio_pull_updown(rksdmmc0_gpio_init.data0_gpio.io,GPIOPullUp);
                ...
                gpio_direction_output(rksdmmc0_gpio_init.data1_gpio.io,GPIO_HIGH);//set mmc0-data1 to low.
                //gpio_pull_updown(rksdmmc0_gpio_init.data1_gpio.io,GPIOPullUp);
                ...
                gpio_direction_output(rksdmmc0_gpio_init.data2_gpio.io,GPIO_HIGH);//set mmc0-data2 to low.
                //gpio_pull_updown(rksdmmc0_gpio_init.data2_gpio.io,GPIOPullUp);
                ...
                gpio_direction_output(rksdmmc0_gpio_init.data3_gpio.io,GPIO_HIGH);//set mmc0-data3 to low.
                //gpio_pull_updown(rksdmmc0_gpio_init.data3_gpio.io,GPIOPullUp);
        ...
        case 1://mmc1
        {
            ...
            if(on)
            {
                ...
                gpio_pull_updown(rksdmmc1_gpio_init.clk_gpio.io,GPIOPullUp);
                ...
                gpio_pull_updown(rksdmmc1_gpio_init.cmd_gpio.io,GPIOPullUp);
                ...
                gpio_pull_updown(rksdmmc1_gpio_init.data0_gpio.io,GPIOPullUp);

                rk30_mux_api_set(rksdmmc1_gpio_init.data1_gpio.iomux.name, rksdmmc1_gpio_init.data1_gpio.iomux.fgpio);
                ...
                gpio_pull_updown(rksdmmc1_gpio_init.data1_gpio.io,GPIOPullUp);

                rk30_mux_api_set(rksdmmc1_gpio_init.data2_gpio.iomux.name, rksdmmc1_gpio_init.data2_gpio.iomux.fgpio);
                ...
                gpio_pull_updown(rksdmmc1_gpio_init.data2_gpio.io,GPIOPullUp);

                rk30_mux_api_set(rksdmmc1_gpio_init.data3_gpio.iomux.name, rksdmmc1_gpio_init.data3_gpio.iomux.fgpio);
                ...
                gpio_pull_updown(rksdmmc1_gpio_init.data3_gpio.io,GPIOPullUp);
                mdelay(100);
            }
            else
            {
...
static void rk29_sdmmc_set_iomux_mmc0(unsigned int bus_width)
{
    switch (bus_width)
    {
        ...
        #if 1 //replace the power control into rk29_sdmmc_set_ios(); modifyed by xbw at 2012-08-12
...
struct rksdmmc_gpio_wifi_moudle  rk_platform_wifi_gpio = {
    ...
    #endif
    #ifdef RK30SDK_WIFI_GPIO_POWER_DOWN_N
    .power_down_n = {
            .io             = RK30SDK_WIFI_GPIO_POWER_DOWN_N,
            .enable         = RK30SDK_WIFI_GPIO_POWER_DOWN_ENABLE_VALUE,
            #ifdef RK30SDK_WIFI_GPIO_POWER_DOWN_PIN_NAME
            .iomux          = {
                .name       = RK30SDK_WIFI_GPIO_POWER_DOWN_PIN_NAME,
                .fgpio      = RK30SDK_WIFI_GPIO_POWER_DOWN_IOMUX_FGPIO,
                #ifdef RK30SDK_WIFI_GPIO_POWER_DOWN_IOMUX_FMUX
                .fmux       = RK30SDK_WIFI_GPIO_POWER_DOWN_IOMUX_FMUX,
                #endif
            },
            #endif
    },
    #endif    
    #ifdef RK30SDK_WIFI_GPIO_POWER_VD_N
    .power_vd_n = {
            .io             = RK30SDK_WIFI_GPIO_POWER_VD_N,
            .enable         = RK30SDK_WIFI_GPIO_POWER_VD_ENABLE_VALUE,
            #ifdef RK30SDK_WIFI_GPIO_POWER_VD_PIN_NAME
            .iomux          = {
                .name       = RK30SDK_WIFI_GPIO_POWER_VD_PIN_NAME,
                .fgpio      = RK30SDK_WIFI_GPIO_POWER_VD_IOMUX_FGPIO,
            },
            #endif
    },
    #endif  
    #ifdef RK30SDK_WIFI_GPIO_POWER_1V8_N
    .power_1v8_n = {
            .io             = RK30SDK_WIFI_GPIO_POWER_1V8_N,
            .enable         = RK30SDK_WIFI_GPIO_POWER_1V8_ENABLE_VALUE,
            #ifdef RK30SDK_WIFI_GPIO_POWER_1V8_PIN_NAME
            .iomux          = {
                .name       = RK30SDK_WIFI_GPIO_POWER_1V8_PIN_NAME,
                .fgpio      = RK30SDK_WIFI_GPIO_POWER_1V8_IOMUX_FGPIO,
            },
            #endif
    },
    #endif  
...
static int __init rk29sdk_wifi_bt_gpio_control_init(void)
{
    ...
    rk29_mux_api_set(rk_platform_wifi_gpio.power_down_n.iomux.name, rk_platform_wifi_gpio.power_down_n.iomux.fgpio);
    rk29_mux_api_set(rk_platform_wifi_gpio.power_vd_n.iomux.name, rk_platform_wifi_gpio.power_vd_n.iomux.fgpio);
    rk29_mux_api_set(rk_platform_wifi_gpio.power_1v8_n.iomux.name, rk_platform_wifi_gpio.power_1v8_n.iomux.fgpio);
    rk29_mux_api_set(rk_platform_wifi_gpio.reset_n.iomux.name, rk_platform_wifi_gpio.reset_n.iomux.fgpio);
...
#endif    
#ifdef RK30SDK_WIFI_GPIO_POWER_DOWN_N
    if (gpio_request(rk_platform_wifi_gpio.power_down_n.io, "wifi power down")) {
           pr_info("%s: request wifi power down gpio failed\n", __func__);
           gpio_free(rk_platform_wifi_gpio.power_down_n.io);
           return -1;
    }
    gpio_direction_output(rk_platform_wifi_gpio.power_down_n.io, (rk_platform_wifi_gpio.power_down_n.enable) );
#endif    
#ifdef RK30SDK_WIFI_GPIO_POWER_VD_N
    if (gpio_request(rk_platform_wifi_gpio.power_vd_n.io, "wifi power vd")) {
           pr_info("%s: request wifi power vd gpio failed\n", __func__);
           gpio_free(rk_platform_wifi_gpio.power_vd_n.io);
           return -1;
    }
    gpio_direction_output(rk_platform_wifi_gpio.power_vd_n.io, !(rk_platform_wifi_gpio.power_vd_n.enable) );
#endif
#ifdef RK30SDK_WIFI_GPIO_POWER_1V8_N
    if (gpio_request(rk_platform_wifi_gpio.power_1v8_n.io, "wifi power 1v8")) {
           pr_info("%s: request wifi power 1v8 gpio failed\n", __func__);
           gpio_free(rk_platform_wifi_gpio.power_1v8_n.io);
           return -1;
    }
    gpio_direction_output(rk_platform_wifi_gpio.power_1v8_n.io, !(rk_platform_wifi_gpio.power_1v8_n.enable) );
#endif   
...
static struct resource resources[] = {
	{
		...
		.name = "mv8787_wlan_irq",
	},
};
static struct resource resources_bt[] = {
	{
		.start = BT_HOST_WAKE,
		.flags = IORESOURCE_IRQ,
		.name = "mv8787_bt_irq",
...
#if (defined(CONFIG_MV8787)|| defined(CONFIG_BT_MV8787))
#include <linux/semaphore.h>
#ifndef DECLARE_MUTEX
#define DECLARE_MUTEX(name) DEFINE_SEMAPHORE(name)
#endif
DECLARE_MUTEX(wifi_bt_power_mutex);
static int mv8787_wifi_power_state = 0,mv8787_bt_power_state = 0;
static int mv8787_wifi_bt_power_state = 0;

static int set_wifi_bt_power(void){	
    if(!(mv8787_wifi_power_state || mv8787_bt_power_state)){
        //set power down.
        rk29sdk_wifi_set_carddetect(0);
        mv8787_wifi_bt_power_state = 0;
	 gpio_set_value(rk_platform_wifi_gpio.power_down_n.io, (rk_platform_wifi_gpio.power_down_n.enable));
        msleep(10);
        gpio_set_value(rk_platform_wifi_gpio.power_down_n.io, !(rk_platform_wifi_gpio.power_down_n.enable));
        gpio_set_value(rk_platform_wifi_gpio.power_n.io, !(rk_platform_wifi_gpio.power_n.enable) );
        gpio_set_value(rk_platform_wifi_gpio.power_vd_n.io, !(rk_platform_wifi_gpio.power_vd_n.enable) );
        gpio_set_value(rk_platform_wifi_gpio.power_1v8_n.io, !(rk_platform_wifi_gpio.power_1v8_n.enable) );
        gpio_set_value(rk_platform_wifi_gpio.reset_n.io, (rk_platform_wifi_gpio.reset_n.enable));
        gpio_set_value(rk_platform_wifi_gpio.power_down_n.io, (rk_platform_wifi_gpio.power_down_n.enable));
        rk29_sdmmc_gpio_open(1, 0);
    }
    else if(!mv8787_wifi_bt_power_state){
        //set power up.
        mv8787_wifi_bt_power_state = 1;
        gpio_set_value(rk_platform_wifi_gpio.power_n.io, (rk_platform_wifi_gpio.power_n.enable) );
        gpio_set_value(rk_platform_wifi_gpio.power_vd_n.io, (rk_platform_wifi_gpio.power_vd_n.enable) );
        gpio_set_value(rk_platform_wifi_gpio.power_1v8_n.io, (rk_platform_wifi_gpio.power_1v8_n.enable) );
        gpio_set_value(rk_platform_wifi_gpio.reset_n.io, !(rk_platform_wifi_gpio.reset_n.enable));
...
#endif
#if defined(CONFIG_MV8787)
static int set_wifi_power_state(int on){
    pr_info("%s: %d\n", __func__, on);
    down(&wifi_bt_power_mutex);
    if (on){
        if(mv8787_wifi_power_state){
            up(&wifi_bt_power_mutex);	
            return 0;
	 }
	 mv8787_wifi_power_state = 1;
        pr_info("wifi turn on power\n");
    }
    else{    
        mv8787_wifi_power_state = 0;
        pr_info("wifi shut off power\n");
    }
    set_wifi_bt_power();
    up(&wifi_bt_power_mutex);
...
static int set_bt_power_state(int on){
    pr_info("%s: %d\n", __func__, on);
    down(&wifi_bt_power_mutex);
    if (on){
        if(mv8787_bt_power_state){
            up(&wifi_bt_power_mutex);
            return 0;
        }
        mv8787_bt_power_state = 1;
        pr_info("BT turn on power\n");
    }else{    
        mv8787_bt_power_state = 0;
...
static struct bt_platform_data rk30sdk_bt_control = {
    .set_power = set_bt_power_state,
    .set_reset = NULL,
    .set_carddetect = NULL,
};
static struct platform_device bt_mv8787_device = {
    .name = "mv8787_rfkill",
    .num_resources = ARRAY_SIZE(resources_bt),
    .resource = resources_bt,
    .id = 1,
    .dev = {
    .platform_data = &rk30sdk_bt_control,
    },
};
#endif
    ...
    #if defined(CONFIG_MV8787)
    static struct wifi_platform_data rk30sdk_wifi_control = {
        .set_power = set_wifi_power_state,
        .set_reset = NULL,
        .set_carddetect = NULL,
        .mem_prealloc   = rk29sdk_mem_prealloc,
    };
    
    static struct platform_device rk30sdk_wifi_device = {
        .name = "mv8787_wlan",
        .num_resources = ARRAY_SIZE(resources),
        .resource = resources,
        .id = 1,
        .dev = {
            .platform_data = &rk30sdk_wifi_control,
        },
    };
    #else
