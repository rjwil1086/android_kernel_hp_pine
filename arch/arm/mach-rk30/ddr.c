...
uint32_t __sramlocalfunc ddr_data_training(void)
{
    uint32 value,cs;
#if 1
        pPHY_Reg->DATX8[0].DXDLLCR &=0xfffc0000;
        pPHY_Reg->DATX8[1].DXDLLCR &=0xfffc0000;
        pPHY_Reg->DATX8[2].DXDLLCR &=0xfffc0000;
        pPHY_Reg->DATX8[3].DXDLLCR &=0xfffc0000;
#endif
...
void __sramlocalfunc ddr_selfrefresh_exit(void)
{
    ...
    #if 1
    pPHY_Reg->DATX8[0].DXDLLCR |=0x04003;
    pPHY_Reg->DATX8[1].DXDLLCR |=0x04003;
    pPHY_Reg->DATX8[2].DXDLLCR |=0x04003;
    pPHY_Reg->DATX8[3].DXDLLCR |=0x04003;
    pPHY_Reg->DATX8[0].DXDQSTR =0x3db0d001 -(0x3<<20) -(0x3<<23) -(0xf<<26);
    pPHY_Reg->DATX8[2].DXDQSTR =0x3db0d001 -(0x3<<20) -(0x3<<23) -(0xf<<26);
    pPHY_Reg->DATX8[1].DXDQSTR =0x3db0d001 -(0x3<<20) -(0x3<<23) -(0xf<<26);
    pPHY_Reg->DATX8[3].DXDQSTR =0x3db0d001 -(0x3<<20) -(0x3<<23) -(0xf<<26);
    pPHY_Reg->DATX8[0].DXDQTR =0x0;
    pPHY_Reg->DATX8[2].DXDQTR =0x0;
    pPHY_Reg->DATX8[1].DXDQTR =0x0;
    pPHY_Reg->DATX8[3].DXDQTR =0x0;
#endif
...
int ddr_init(uint32_t dram_speed_bin, uint32_t freq)
{
    ...
    ddr_print("version 1.00 20130522\n");
