...
#define MLAN_RELEASE_VERSION		"364-20130402_v12"
...
typedef struct _mlan_callbacks
{
    ...
    /** moal_udelay */
      ...
      t_void(*moal_msleep) (IN t_void * pmoal_handle, IN t_u32 msec); //titan msleep
      t_bool(*moal_set_get_first_wakeup_card) (IN t_void * pmoal_handle, IN t_bool action, IN t_bool value); //titan msleep
