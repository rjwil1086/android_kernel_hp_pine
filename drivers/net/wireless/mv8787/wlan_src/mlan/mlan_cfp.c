...
static country_code_mapping_t country_code_mapping[] = {
    ...
    {"BR", 0x01, 0x09},         /* Brazil */
    {"RU", 0x30, 0x0f},         /* Russia */
     {"HP", 0xAA,0x40},              /*Special for HP ,add by king.xu 2013.08.05*/
};
...
/** Band : 'B/G', Region: Special for HP */
static chan_freq_power_t channel_freq_power_SPECIAL_HP[] = {
    {1, 2412, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
	    {2, 2417, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
	    {3, 2422, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
	    {4, 2427, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
	   ...
	   {9, 2452, WLAN_TX_PWR_JP_BG_DEFAULT, MFALSE},
	    ...
	    {12, 2467, WLAN_TX_PWR_JP_BG_DEFAULT, MTRUE},
	    {13, 2472, WLAN_TX_PWR_JP_BG_DEFAULT, MTRUE},
	    {14, 2484, WLAN_TX_PWR_JP_BG_DEFAULT, MTRUE}
};
...
static cfp_table_t cfp_table_BG[] = {
    ...
    ,
	{0xaa,                      /* Special for HP*/
         channel_freq_power_SPECIAL_HP,
         sizeof(channel_freq_power_SPECIAL_HP) / sizeof(chan_freq_power_t),
     }
	,
/* Add new region here */
};
...
t_u16 region_code_index[MRVDRV_MAX_REGION_CODE] =
    { 0x10, 0x20, 0x30, 0x32, 0x40, 0x41, 0x50, 0xaa,0xfe, 0xff }; /*Special for HP ,add 0xaa for king.xu 2013.08.05*/
